...
parameterSchema = {
    ...
    "additive": {
        ...
        "infillDensity":                {"type": int,   "min": 0,    "max": 100,    "default": 40,    "unit": "%",      "required": True,  "description": "填充密度"},
    ...
    "subtractive": {
        ...
        "step1TiltAngleDeg":        {"type": float, "min": 0.0,  "max": 90.0,   "default": 45.0,  "unit": "deg",    "required": False, "description": "外壳去除侧倾角"},
        "step1TiltCount":           {"type": int,   "min": 0,    "max": 4,      "default": 4,                       "required": False, "description": "外壳去除侧倾轴数"},
