...
parameterSchema = {
    ...
    "additive": {
        "layerHeight":                  {"type": float, "min": 0.08, "max": 0.4,    "default": 0.15,  "unit": "mm",     "required": True,  "description": "层高"},
        "wallThickness":                {"type": float, "min": 0.4,  "max": 10.0,   "default": 1.6,   "unit": "mm",     "required": True,  "description": "壁厚"},
        "wallLineCount":                {"type": int,   "min": 1,    "max": 10,     "default": 4,     "unit": "lines",  "required": True,  "description": "壁线数"},
        "infillDensity":                {"type": int,   "min": 0,    "max": 100,    "default": 100,   "unit": "%",      "required": True,  "description": "填充密度"},
        "infillPattern":                {"type": str,   "options": ["grid","honeycomb","gyroid","cubic","tetrahedral"], "default": "cubic", "required": True, "description": "填充图案"},
        ...
        "roofingLayerCount":            {"type": int,   "min": 0,    "max": 10,     "default": 2,                       "required": False, "description": "顶面层数"},
        "flooringLayerCount":           {"type": int,   "min": 0,    "max": 10,     "default": 2,                       "required": False, "description": "底面层数"},
        ...
        "extrusionScaleFactor":         {"type": float, "min": 0.01, "max": 100.0,  "default": 3.0,                     "required": False, "description": "E→C轴换算系数"},
        ...
        "retractionMinTravelDistance":  {"type": float, "min": 0.0,  "max": 50.0,   "default": 10.0,  "unit": "mm",     "required": False, "description": "回抽最小空行程"},
    ...
    "subtractive": {
        ...
        "spindleSpeed":             {"type": int,   "min": 100,  "max": 60000,  "default": 500,  "unit": "rpm",    "required": True,  "description": "主轴转速"},
        "feedRate":                 {"type": int,   "min": 1,    "max": 5000,   "default": 100,   "unit": "mm/min", "required": True,  "description": "进给速度"},
        "toolDiameter":             {"type": float, "min": 0.1,  "max": 20.0,   "default": 4.8,   "unit": "mm",     "required": True,  "description": "刀具直径"},
        ...
        "shellRoughStock":          {"type": float, "min": 0.0,  "max": 5.0,    "default": 0.0,   "unit": "mm",     "required": False, "description": "外壳去除余量"},
        "step1TiltAngleDeg":        {"type": float, "min": 0.0,  "max": 90.0,   "default": 60.0,  "unit": "deg",    "required": False, "description": "外壳去除侧倾角"},
        "step1TiltCount":           {"type": int,   "min": 0,    "max": 4,      "default": 0,                       "required": False, "description": "外壳去除侧倾轴数"},
        "step1UseContour":          {"type": bool,                              "default": True,                    "required": False, "description": "外壳去除每层先走轮廓环"},
        "step1ContourPasses":       {"type": int,   "min": 1,    "max": 8,      "default": 2,                       "required": False, "description": "外壳去除每层轮廓环道数"},
        "step1SafeClearance":       {"type": float, "min": 0.0,  "max": 10.0,   "default": 0.75,  "unit": "mm",     "required": False, "description": "外壳去除零件保护余量"},
