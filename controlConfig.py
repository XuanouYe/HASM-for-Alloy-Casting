...
parameterSchema = {
    ...
    "additive": {
        ...
        "printSpeedLayer0": {"type": int, "min": 5, "max": 100, "default": 40, "unit": "mm/s", "required": False},
        ...
        "retractionDistance": {"type": float, "min": 0.0, "max": 50.0, "default": 20.0, "unit": "mm", "required": False},
